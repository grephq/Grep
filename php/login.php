<?php
    ...
    if(isset($_POST['login'])){
        ...
        $query = "select * from errand_staff where email='$email'";
        ...
        if($result){
            ...
            // echo '<div class="alert au-alert-danger alert-dismissible fade show au-alert au-alert--70per" role="alert">
            //         <i class="zmdi zmdi-check-circle"></i>
            //         <span class="content">Incorrect Username/Password.</span>
