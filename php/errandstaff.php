        ...
        <div class="page-content--bgf7">
            ...
            <section class="p-t-20">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h3 class="title-5 m-b-35">Errands</h3>
                            <div class="table-data__tool">
                                <div class="table-data__tool-left">
                                    ...
                                    <button class="btn btn-primary">
                                        <a class="text-white" href="errandstaffhistory.php">History</a></button>
                                </div>
                            </div>
                            <div class="table-responsive table-responsive-data2">
                                <table class="table table-data2">
                                    ...
                                    <tbody>
                            <?php
                                 $query = "select * from errands order by id desc";
                                     ...
                                     if(mysqli_num_rows($result) > 0){
                                        ...
                                        while($count < $rows){
                                            ...
                                            if($response['status'] == "Available"){
                                                ...
                                                $btnStatus = "visible";
                                            }elseif($response['status'] == "Ongoing"){
                                                $status = "text-warning";
                                                $btnStatus = "hidden";
                                            ...
                                            echo ('
                                                    ...
                                                    <td>' . $free . '</td>
                                                        ...
                                                        <td>' . $response['pickup'] . '</td>
                                                        <td>' . $response['dropoff'] . '</td>
                                                        <td>
                                                            <div class="table-data-feature">
                                                                <form method="POST" action="accept.php">
                                                                <input value="' . $response['id'] . '" name="id" hidden>
                                                                <input value="' . $_SESSION["lname"] . " " . $_SESSION['fname'] . '" name="acceptedby" hidden>
                                                                <input type="submit" id="accept" class="btn btn-success" value="Accept" style="visibility:' . $btnStatus .';">
                                                                </form>
